...
public class DrawThread extends Thread implements Resetable{
	...
	private ModeButton copyButton;
	private ChangeSpeedButton plusButton;
	private ChangeSpeedButton minusButton;
	private ResetButton resetButton;
	private SettingsButton settingsButtonL1;
	private SettingsButton settingsButtonL2;
	private SettingsButton settingsButtonM1;
	private SettingsButton settingsButtonM2;
	private SettingsButton settingsButtonK1;
	private SettingsButton settingsButtonK2;
	...
	DrawThread(Context context, SurfaceHolder surfaceHolder) {
		...
		rdmButton = new ModeButton(new Rect((int)(x2+width*0.22),(int)(y1+height*0.08),(int)(x2+width*0.28),(int)(y1+height*0.14)),"Rand",this,2);
		...
		copyButton = new ModeButton(new Rect((int)(x2+width*0.22),(int)(y1+height*0.24),(int)(x2+width*0.28),(int)(y1+height*0.30)),"Copy",this,4);
		settingsButtonL1 = new SettingsButton(new Rect((int)(x2+width*0.17),(int)(y1+height*0.70),(int)(x2+width*0.21),(int)(y1+height*0.74)),"-",this,-1);
		settingsButtonL2 = new SettingsButton(new Rect((int)(x2+width*0.265),(int)(y1+height*0.70),(int)(x2+width*0.305),(int)(y1+height*0.74)),"+",this,1);
		settingsButtonM1 = new SettingsButton(new Rect((int)(x2+width*0.17),(int)(y1+height*0.77),(int)(x2+width*0.21),(int)(y1+height*0.81)),"-",this,-2);
		settingsButtonM2 = new SettingsButton(new Rect((int)(x2+width*0.265),(int)(y1+height*0.77),(int)(x2+width*0.305),(int)(y1+height*0.81)),"+",this,2);
		settingsButtonK1 = new SettingsButton(new Rect((int)(x2+width*0.17),(int)(y1+height*0.84),(int)(x2+width*0.21),(int)(y1+height*0.88)),"-",this,-3);
		settingsButtonK2 = new SettingsButton(new Rect((int)(x2+width*0.265),(int)(y1+height*0.84),(int)(x2+width*0.305),(int)(y1+height*0.88)),"+",this,3);
		...
		copyButton.setTextSize(25);
		settingsButtonL1.setTextSize(30);
		settingsButtonL2.setTextSize(30);
		settingsButtonM1.setTextSize(30);
		settingsButtonM2.setTextSize(30);
		settingsButtonK1.setTextSize(30);
		settingsButtonK2.setTextSize(30);
	...
	void putCell(int x,int y)
	{
		try {
			...
			else
			{
				choosed.setX(x);
				choosed.setY(y);
				choosed.setEnergy(100);
				choosed.setCurrent(0);
				game.putCell(choosed);
			}
		}
		catch(Exception e)
		{
	...
	void onTouch(int x,int y)
	{
		...
		copyButton.checkForTouch(x,y);
		settingsButtonL1.checkForTouch(x,y);
		settingsButtonL2.checkForTouch(x,y);
		settingsButtonM1.checkForTouch(x,y);
		settingsButtonM2.checkForTouch(x,y);
		settingsButtonK1.checkForTouch(x,y);
		settingsButtonK2.checkForTouch(x,y);
	}
	...
	{
		Paint paint=new Paint();
		paint.setARGB(255,218, 165, 32);
		canvas.drawRoundRect((float)(x2+width*0.03),(float)(y1+height*0.63),(float)(x2+width*0.33),(float)(y2+height*0.23),25,25,paint);
		paint.setColor(Color.BLACK);
		paint.setTextSize(40);
		canvas.drawText("Settings",(float)(x2+width*0.135),(float)(y1+height*0.69),paint);
		paint.setTextSize(30);
		canvas.drawText("Light level: ",(float)(x2+width*0.06),(float)(y1+height*0.73),paint);
		canvas.drawText((int)(game.getLightKoef()*100)+ "%",(float)(x2+width*0.215),(float)(y1+height*0.73),paint);
		canvas.drawText("Mineral level:",(float)(x2+width*0.06),(float)(y1+height*0.80),paint);
		canvas.drawText((int)(game.getMineralKoef()*100)+ "%",(float)(x2+width*0.215),(float)(y1+height*0.80),paint);
		canvas.drawText("Kill level:",(float)(x2+width*0.06),(float)(y1+height*0.87),paint);
		canvas.drawText((int)(game.getKillKoef()*100)+ "%",(float)(x2+width*0.215),(float)(y1+height*0.87),paint);
		settingsButtonL1.draw(canvas);
		settingsButtonL2.draw(canvas);
		settingsButtonM1.draw(canvas);
		settingsButtonM2.draw(canvas);
		settingsButtonK1.draw(canvas);
		settingsButtonK2.draw(canvas);
	}
	...
	void onSettingsTouch(int type) {
		switch(type)
		{
			case -1:
				game.changeLight((float) -0.1);
				break;
			case 1:
				game.changeLight((float) 0.1);
				break;
			case -2:
				game.changeMineral((float) -0.1);
				break;
			case 2:
				game.changeMineral((float) 0.1);
				break;
			case -3:
				game.changeKill((float) -0.1);
				break;
			case 3:
				game.changeKill((float) 0.1);
				break;
